...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="logo">
                <img src="../public/landing/images/logo-kabgor.png" alt="Logo gorut" width="10" height="10">
            </div>
        ...
        <div class="content">
            ...
            <div class="text-pendahuluan">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan
                di bawah ini, Kepala Desa Modelidu Kecamatan
                Telaga Biru Kabupaten Gorontalo menerangkan kepada :</div>
            <div class="table">
                <table>
                    <tr>
